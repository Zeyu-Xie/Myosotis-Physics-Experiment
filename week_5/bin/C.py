...
plt.title('Amplitude Frequency Characteristic Curve (Damping = 4)')
plt.xlabel('ω / ω₀')
plt.ylabel('θₘ')
...
plt.title('Phase Frequency Characteristic Curve (Damping = 4)')
plt.xlabel('ω / ω₀')
plt.ylabel('φ')
plt.plot(sheet2_1, sheet2_3, '.', label='Data')
plt.legend()
plt.savefig(os.path.join(os.path.dirname(__file__), "C_3.png"))
plt.close()